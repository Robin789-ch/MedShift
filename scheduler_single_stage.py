...
FRONTEND_URL = "http://127.0.0.1:8001/schedule"
...
def solve_shift_scheduling(config: dict[str, Any], params: str, output_proto: str):
    ...
    print()
    print("Single-stage solver stats:")
...
def solve_schedule(config: dict[str, Any], params: str, output_proto: str):
    """Runs the experimental single-stage shift and department optimizer."""
    print("Single-stage schedule")
